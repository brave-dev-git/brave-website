...
export const relatedServicesByPath: Record<string, { intro?: string; items: RelatedItem[] }> = {
  "/tjanster/mognadsanalys/": {
    ...
    items: [
      ...
      { label: "CISO as a Service", href: "/tjanster/cisoaas-executive-advisor/", description: "Styrning, prioritering och uppföljning över tid." },
    ],
  ...
  "/tjanster/cisoaas-executive-advisor/": {
  ...
  "/tjanster/cybersakerhetslagen/": {
    ...
    items: [
      ...
      { label: "CISO as a Service", href: "/tjanster/cisoaas-executive-advisor/", description: "Få löpande strategiskt stöd genom CISO as a Service." },
    ],
    insightTags: ["NIS2"],
    insightLimit: 2,
},
  ...
  "/tjanster/riskworkshop/": {
    ...
    items: [
      ...
      { label: "CISO as a Service", href: "/tjanster/cisoaas-executive-advisor/", description: "Håll riktning och följ upp över tid." },
    ],
  ...
  "/ai-sakerhet/": {
    ...
    items: [
      ...
      { label: "CISO as a Service", href: "/tjanster/cisoaas-executive-advisor/", description: "Stöd för beslutsfattande och uppföljning." },
    ],
    insightTags: ["AI"],
    insightLimit: 2,
  },
